...
import { useDndSelector, useSortableItem } from "@/components/dnd"
import Icon from "../Icon"
import { highlight, useSearchContextSelector } from "../search/searchContext"
...
const ListItem: FC<ListItemProps> = ({
	...
	const { query, jumped } = useSearchContextSelector((v) => ({
		query: v.query,
		jumped: v.jumped,
	}))
	const dev = useSettingsContextSelector((v) => v.settings.dev) // TODO: dev, delete
