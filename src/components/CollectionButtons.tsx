...
import {
	// useOperationsContext,  // TODO: delete
	useOperationsContextSelector,
} from "@/components/operations/operationsContext"
...
export const CollectoinActionButtons: FC<CollectionActionButtonsProps> = ({
	...
	const {
		...
		pinnedCollection: v.pinnedCollection,
		deleteCollection: v.deleteCollection,
		activeTitleInput: v.activeTitleInput,
		copy: v.copy,
		paste: v.paste,
		clone: v.clone,
	}))
...
const DropDownActionButton: FC<DropDownActionButtonProps> = ({
	...
	const { current, type, collections } = useGlobalCtxSelector((v) => ({
		current: v.current,
		type: v.type,
	...
	const {
		...
		deleteCollection: v.deleteCollection,
		activeTitleInput: v.activeTitleInput,
		openChooseCollectionDialog: v.openChooseCollectionDialog,
		copy: v.copy,
		paste: v.paste,
		clone: v.clone,
	}))
