...
import { exportFile, generateData } from "@/utils/data"
...
const useExport = () => {
	...
	const [collectionLength, setCollectionLength] = useState(collections.length)  // BUG: ?
	...
	useEffect(() => {
		...
		modalInstance.current?.update({ content })
	}, [count])
